    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-6">
        <div className="flex border-b border-border-light dark:border-border-dark">
          <button className="px-4 py-2 text-sm font-medium text-text-secondary-light dark:text-text-secondary-dark hover:text-text-primary-light dark:hover:text-text-primary-dark">เช็คชื่อรายวัน</button>
          <button className="px-4 py-2 text-sm font-semibold border-b-2 border-primary text-primary">สรุปจำนวนวันมาเรียนใน 1 ปี</button>
        </div>
            ...
            <table className="w-full text-left text-sm text-text-primary-light dark:text-text-primary-dark">
              <thead className="bg-gray-50 dark:bg-gray-800 text-center">
                <tr>
                  ...
                  {/* Add month headers here */}
                </tr>
              </thead>
              <tbody>
                {/* Add student attendance summary rows here */}
              </tbody>
            </table>
          </div>
        </div>
